...
if($_GET){
    if(isset($_GET['sub'])){
        if(is_numeric($_GET['sub'])){
            ...
            if($subResult){
                ...
                $productsResult = $productObject->readBySub();
            }else{
        ...
        if(is_numeric($_GET['cat'])){
            ...
            if($catResult){
                ...
                $productsResult = $productObject->readByCat();
            }else{
                header('location:errors/404.php');die;
            }
        }else{
        ...
        if(is_numeric($_GET['brand'])){
            ...
            $brandResult = $brandObject->getBrandById();
            if($brandResult){
                $productObject->setBrand_id($_GET['brand']);
                $productsResult = $productObject->readByBrand();
            }else{
                header('location:errors/404.php');die;
            }
        }else{
    ...
    $productsResult = $productObject->read();
}
                                ...
                                ?>
                                    <li> <a data-toggle="collapse" data-parent="#faq" href="#shop-catigory-<?= $index ?>">
                                        ...
                                        <ul id="shop-catigory-<?= $index ?>" class="panel-collapse collapse ">
                                            ...
                                            $subcategoriesResult = $subcategoryObject->read();
                                            if (!empty($subcategoriesResult)) {
